# Zena Smart Dustbin Management System

Final year project (Zena Smart Dustbin Management System) implemented with filament PHP.
...
```bash
git clone https://github.com/omakei/zena-dustbin-project.git
```
